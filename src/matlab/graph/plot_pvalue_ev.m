...
switch nargin
    case 4
        ...
        figure
        hold on
        errorbar(delta_mu_val, p_value(1,:), std_value(1,:), 'k-');
        errorbar(delta_mu_val, p_value(2,:), std_value(2,:), 'b-');
        errorbar(delta_mu_val, p_value(3,:), std_value(3,:), 'b:');
        errorbar(delta_mu_val, p_value(4,:), std_value(4,:), 'r-');
        errorbar(delta_mu_val, p_value(5,:), std_value(5,:), 'r--');
        errorbar(delta_mu_val, p_value(6,:), std_value(6,:), 'r:');
        plot(delta_mu_val,ones(1,length(delta_mu_val))*0.05,'g-');
        hold off
    case 3
